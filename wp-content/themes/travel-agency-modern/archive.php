...
tam_render_page_intro(
	array(
		'eyebrow'     => __( 'Archive', 'travel-agency-modern' ),
		...
		<div class="tam-container">
			...
			<?php else : ?>
				<div class="tam-empty-state">
					...
					<p><?php esc_html_e( 'Thử mở rộng phạm vi lọc hoặc quay lại trang cẩm nang để tiếp tục khám phá.', 'travel-agency-modern' ); ?></p>
				</div>
			<?php endif; ?>
		</div>
	</section>

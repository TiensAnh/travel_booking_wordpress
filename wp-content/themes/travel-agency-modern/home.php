	...
	<section class="tam-section tam-section--compact">
		<div class="tam-container">
			<div class="tam-content-card tam-rich-content tam-guide-intro">
				<p><?php esc_html_e( 'Cẩm nang du lịch là nơi ADN Travel gom lại những kinh nghiệm thực tế trước mỗi chuyến đi: chọn thời điểm đẹp, chuẩn bị hành lý, dự trù chi phí, lưu ý văn hóa địa phương và cách sắp xếp lịch trình sao cho nhẹ nhàng hơn.', 'travel-agency-modern' ); ?></p>
